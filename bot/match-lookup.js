...
const MATCH_LOOKUP = {
  ...
  // ── За 3-е место и финал — пары резолвнуты по итогам 1/2 ──────────────────
  'FRA_ENG': 'm103', // L(m101)=FRA vs L(m102)=ENG — проигравшие полуфиналов
  'ESP_ARG': 'm104', // W(m101)=ESP vs W(m102)=ARG — победители полуфиналов
}
