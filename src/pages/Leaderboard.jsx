    ...
    <div className="page-content px-4 pb-4">
      ...
      <div className="flex flex-col items-center justify-center py-12 gap-5">
        ...
        <div className="text-center">
          ...
          <p className="text-xs uppercase tracking-wider" style={{ color: '#9CA3AF' }}>Рейтинг появится после первых матчей</p>
        </div>
        <div
        ...
        >
          🥇 Лучший прогнозист получит признание в чемпионате
        </div>
      </div>
    </div>
  )
